...
function AJM:SettingsCreate()
	...
	AJM.settingsControl.widgetSettings.content:SetHeight( -bottomOfQuestWatcherOptions )
...
function AJM:SettingsCreateQuestWatcherControl( top )
	...
	JambaHelperSettings:CreateHeading( AJM.settingsControl, L["Quest Watcher"], movingTop, true )
	movingTop = movingTop - headingHeight
	-- Check box: Enable auto quest completion.
	AJM.settingsControl.checkBoxEnableQuestWatcher = JambaHelperSettings:CreateCheckBox(
		AJM.settingsControl,
		headingWidth,
		column1Left,
		movingTop,
	...
	AJM.settingsControl.checkBoxShowFrame = JambaHelperSettings:CreateCheckBox(
		AJM.settingsControl,
		headingWidth,
		left,
		movingTop,
	...
	movingTop = movingTop - checkBoxHeight
	AJM.settingsControl.checkBoxUnlockWatcherFrame = JambaHelperSettings:CreateCheckBox(
		AJM.settingsControl,
		headingWidth,
		left,
		movingTop,
	...
	movingTop = movingTop - checkBoxHeight
	AJM.settingsControl.checkBoxHideBlizzardWatchFrame = JambaHelperSettings:CreateCheckBox(
		AJM.settingsControl,
		headingWidth,
		left,
		movingTop,
	...
	movingTop = movingTop - checkBoxHeight
	AJM.settingsControl.checkBoxEnableQuestWatcherMasterOnly = JambaHelperSettings:CreateCheckBox(
		AJM.settingsControl,
		headingWidth,
		column1Left,
		movingTop,
	...
	movingTop = movingTop - checkBoxHeight
	AJM.settingsControl.displayOptionsCheckBoxHideQuestWatcherInCombat = JambaHelperSettings:CreateCheckBox(
		AJM.settingsControl,
		headingWidth,
		column1Left,
		movingTop,
	...
	movingTop = movingTop - checkBoxHeight
	AJM.settingsControl.checkBoxShowCompletedObjectivesAsDone = JambaHelperSettings:CreateCheckBox(
		AJM.settingsControl,
		headingWidth,
		left,
		movingTop,
	...
	movingTop = movingTop - checkBoxHeight
	AJM.settingsControl.checkBoxHideQuestIfAllComplete = JambaHelperSettings:CreateCheckBox(
		AJM.settingsControl,
		headingWidth,
		left,
		movingTop,
	...
	movingTop = movingTop - checkBoxHeight
	AJM.settingsControl.checkBoxShowDoNotHideCompletedObjectives = JambaHelperSettings:CreateCheckBox(
		AJM.settingsControl,
		headingWidth,
		left,
		movingTop,
	...
	movingTop = movingTop - checkBoxHeight
	AJM.settingsControl.checkBoxSendProgressChatMessages = JambaHelperSettings:CreateCheckBox(
		AJM.settingsControl,
		headingWidth,
		left,
		movingTop,
	...
	movingTop = movingTop - verticalSpacing
	AJM.settingsControl.displayOptionsQuestWatcherLinesSlider = JambaHelperSettings:CreateSlider(
		AJM.settingsControl,
		headingWidth,
		column1Left,
		movingTop,
	...
	AJM.settingsControl.displayOptionsQuestWatcherLinesSlider:SetSliderValues( 5, 50, 1 )
	AJM.settingsControl.displayOptionsQuestWatcherLinesSlider:SetCallback( "OnValueChanged", AJM.SettingsChangeWatchLines )
	movingTop = movingTop - sliderHeight - verticalSpacing
	AJM.settingsControl.displayOptionsQuestWatcherFrameWidthSlider = JambaHelperSettings:CreateSlider(
		AJM.settingsControl,
		headingWidth,
		column1Left,
		movingTop,
	...
	AJM.settingsControl.displayOptionsQuestWatcherFrameWidthSlider:SetSliderValues( 250, 600, 5 )
	AJM.settingsControl.displayOptionsQuestWatcherFrameWidthSlider:SetCallback( "OnValueChanged", AJM.SettingsChangeWatchFrameWidth )
	movingTop = movingTop - sliderHeight - verticalSpacing
	AJM.settingsControl.displayOptionsQuestWatcherMediaBorder = JambaHelperSettings:CreateMediaBorder(
		AJM.settingsControl,
		headingWidth,
		column1Left,
		movingTop,
	...
	AJM.settingsControl.displayOptionsQuestWatcherMediaBorder:SetCallback( "OnValueChanged", AJM.SettingsChangeBorderStyle )
	movingTop = movingTop - mediaHeight - verticalSpacing
	AJM.settingsControl.questWatchBorderColourPicker = JambaHelperSettings:CreateColourPicker(
		AJM.settingsControl,
		headingWidth,
		column1Left,
		movingTop,
	...
	AJM.settingsControl.questWatchBorderColourPicker:SetHasAlpha( true )
	AJM.settingsControl.questWatchBorderColourPicker:SetCallback( "OnValueConfirmed", AJM.SettingsQuestWatchBorderColourPickerChanged )
	movingTop = movingTop - checkBoxHeight - verticalSpacing
	AJM.settingsControl.displayOptionsQuestWatcherMediaBackground = JambaHelperSettings:CreateMediaBackground(
		AJM.settingsControl,
		headingWidth,
		column1Left,
		movingTop,
	...
	AJM.settingsControl.displayOptionsQuestWatcherMediaBackground:SetCallback( "OnValueChanged", AJM.SettingsChangeBackgroundStyle )
	movingTop = movingTop - mediaHeight - verticalSpacing
	AJM.settingsControl.questWatchBackgroundColourPicker = JambaHelperSettings:CreateColourPicker(
		AJM.settingsControl,
		headingWidth,
		column1Left,
		movingTop,
	...
	AJM.settingsControl.questWatchBackgroundColourPicker:SetHasAlpha( true )
	AJM.settingsControl.questWatchBackgroundColourPicker:SetCallback( "OnValueConfirmed", AJM.SettingsQuestWatchBackgroundColourPickerChanged )
	movingTop = movingTop - checkBoxHeight - verticalSpacing
	AJM.settingsControl.displayOptionsQuestWatcherScaleSlider = JambaHelperSettings:CreateSlider(
		AJM.settingsControl,
		headingWidth,
		column1Left,
		movingTop,
	...
	AJM.settingsControl.displayOptionsQuestWatcherScaleSlider:SetSliderValues( 0.5, 2, 0.01 )
	AJM.settingsControl.displayOptionsQuestWatcherScaleSlider:SetCallback( "OnValueChanged", AJM.SettingsChangeScale )
	movingTop = movingTop - sliderHeight - verticalSpacing
	AJM.settingsControl.displayOptionsQuestWatcherTransparencySlider = JambaHelperSettings:CreateSlider(
		AJM.settingsControl,
		headingWidth,
		column1Left,
		movingTop,
	...
	AJM.settingsControl.displayOptionsQuestWatcherTransparencySlider:SetSliderValues( 0, 1, 0.01 )
	AJM.settingsControl.displayOptionsQuestWatcherTransparencySlider:SetCallback( "OnValueChanged", AJM.SettingsChangeTransparency )
	movingTop = movingTop - sliderHeight - verticalSpacing
	return movingTop
end
...
function AJM:SettingsRefresh()
	...
	AJM.settingsControl.checkBoxEnableQuestWatcher:SetValue( AJM.db.enableQuestWatcher )
	AJM.settingsControl.displayOptionsQuestWatcherMediaBorder:SetValue( AJM.db.borderStyle )
	AJM.settingsControl.displayOptionsQuestWatcherMediaBackground:SetValue( AJM.db.backgroundStyle )
	AJM.settingsControl.displayOptionsCheckBoxHideQuestWatcherInCombat:SetValue( AJM.db.hideQuestWatcherInCombat )
	AJM.settingsControl.displayOptionsQuestWatcherTransparencySlider:SetValue( AJM.db.watcherFrameAlpha )
	AJM.settingsControl.displayOptionsQuestWatcherScaleSlider:SetValue( AJM.db.watcherFrameScale )
	AJM.settingsControl.checkBoxEnableQuestWatcherMasterOnly:SetValue( AJM.db.enableQuestWatcherOnMasterOnly )
	AJM.settingsControl.questWatchBackgroundColourPicker:SetColor( AJM.db.watchFrameBackgroundColourR, AJM.db.watchFrameBackgroundColourG, AJM.db.watchFrameBackgroundColourB, AJM.db.watchFrameBackgroundColourA )
	AJM.settingsControl.questWatchBorderColourPicker:SetColor( AJM.db.watchFrameBorderColourR, AJM.db.watchFrameBorderColourG, AJM.db.watchFrameBorderColourB, AJM.db.watchFrameBorderColourA )
	AJM.settingsControl.displayOptionsQuestWatcherLinesSlider:SetValue( AJM.db.watcherListLines )
	AJM.settingsControl.displayOptionsQuestWatcherFrameWidthSlider:SetValue( AJM.db.watcherFrameWidth )
	AJM.settingsControl.checkBoxUnlockWatcherFrame:SetValue( AJM.db.unlockWatcherFrame )
	AJM.settingsControl.checkBoxHideBlizzardWatchFrame:SetValue( AJM.db.hideBlizzardWatchFrame )
	AJM.settingsControl.checkBoxShowCompletedObjectivesAsDone:SetValue( AJM.db.showCompletedObjectivesAsDone  )
	AJM.settingsControl.checkBoxShowDoNotHideCompletedObjectives:SetValue( AJM.db.doNotHideCompletedObjectives )
	AJM.settingsControl.checkBoxHideQuestIfAllComplete:SetValue( AJM.db.hideQuestIfAllComplete )
	AJM.settingsControl.checkBoxShowFrame:SetValue( AJM.db.showFrame )
	AJM.settingsControl.dropdownMessageArea:SetValue( AJM.db.messageArea )
	AJM.settingsControl.checkBoxSendProgressChatMessages:SetValue( AJM.db.sendProgressChatMessages )
	-- Quest watcher state.
	AJM.settingsControl.displayOptionsQuestWatcherMediaBorder:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.displayOptionsQuestWatcherMediaBackground:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.displayOptionsCheckBoxHideQuestWatcherInCombat:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.displayOptionsQuestWatcherTransparencySlider:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.displayOptionsQuestWatcherScaleSlider:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.checkBoxEnableQuestWatcherMasterOnly:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.questWatchBackgroundColourPicker:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.questWatchBorderColourPicker:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.displayOptionsQuestWatcherLinesSlider:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.displayOptionsQuestWatcherFrameWidthSlider:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.checkBoxUnlockWatcherFrame:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.checkBoxHideBlizzardWatchFrame:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.checkBoxShowCompletedObjectivesAsDone:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.checkBoxShowDoNotHideCompletedObjectives:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.checkBoxHideQuestIfAllComplete:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.checkBoxShowFrame:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.dropdownMessageArea:SetDisabled( not AJM.db.enableQuestWatcher )
	AJM.settingsControl.checkBoxSendProgressChatMessages:SetDisabled( not AJM.db.enableQuestWatcher )
...
function AJM:GetUpdatedCharacterObjectiveIndexInWatchList( questID, objectiveIndex, characterName, amountCompleted, objectiveHeaderPosition, objectiveFinished )
	local characterPosition = -1
	local characterQuestWatchInfo = nil
	local charactersInWatchList = {}
	for key, questWatchInfoContainer in pairs( AJM.questWatchObjectivesList ) do
		local questWatchInfo = questWatchInfoContainer.info
		local position = questWatchInfoContainer.position
		local characterAmount
		if questWatchInfo.questID == questID and questWatchInfo.type == "CHARACTER_AMOUNT" and questWatchInfo.objectiveIndex == objectiveIndex then
			table.insert(charactersInWatchList, questWatchInfo.character)
		end
	end

	AJM:GetCharacterInWatchList( questID, objectiveIndex, characterName, amountCompleted, objectiveHeaderPosition, objectiveFinished )
end
...
getTeamCharacters = nil
function AJM:UpdateTeamQuestCountAddCharacter( questWatchInfo, characterName )
	questWatchInfo.teamCharacters[characterName] = JambaApi.GetPositionForCharacterNameOnline(characterName)
	--local updatedQuestWatchInfo = AJM:SortTeamCharacters(questWatchInfo);
	table.sort(questWatchInfo.teamCharacters, function(a, b) return a[2] > b[2] end);
	getTeamCharacters = { questWatchInfo.key, questWatchInfo.teamCharacters }
...
function AJM:SortTeamCharacters(questWatchList)
	...
	-- sort
	local function SortTable(sortTable)
		local t = {}
		for title, value in pairsByKeys(sortTable, iter) do
	...
	SortTable(questWatchList.teamCharacters)

	return questWatchList
end
