	...
	local configuration = {
		...
		args = {	
			...
			talk = {
				...
				desc = "Send chat message to all characters in the tag",
				usage = "/jamba-talk talk <channel> message <tag>",
				get = false,
				set = "SendGeneralMessageThroughTeam",
			},
		},
	}
...
AJM.COMMAND_SEND_MESSAGE_ALL = "JmbTlkSnd"
...
function AJM:JambaOnCommandReceived( characterName, commandName, ... )
	if commandName == AJM.COMMAND_SEND_MESSAGE_ALL then
		AJM:GetSendGeneralMessageThroughTeam( ... )
	end
end



function AJM:SendGeneralMessageThroughTeam( ... )
	local message, tag = ...
	local fChat = "RAID"

	AJM:JambaSendCommandToTeam(characterName, AJM.COMMAND_SEND_MESSAGE_ALL, fChat, message, tag )
end

function AJM:GetSendGeneralMessageThroughTeam( ... )
	local chat, message, tag = ...
