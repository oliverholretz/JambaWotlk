...
AJM.moduleName = "Jamba-Currency"
AJM.settingsDatabaseName = "JambaCurrProfileDB"
AJM.chatCommand = "jamba-currency"
...
AJM.currTypes.ArenaPoints = 43307
AJM.currTypes.HonorPoints = 43308
AJM.currTypes.StoneKeepersShard = 43228
AJM.currTypes.WintergraspMarkOfHonor = 43589



-- Pseudo GetCurrencyInfo()
		...
		if isHeader ~= true then
			if id == itemID then
				...
				elseif extraCurrencyType == 2 then
					...
					icon = "Interface\\PVPRankBadges\\PvPRank"..factionGroup
				end
				return name, count, icon, 0, 0, 0, nil, nil
			end
		end
	end
	return "", 0, "inv_misc_questionmark", 0, 0, 0, nil, nil
end
...
AJM.settings = {
	profile = {
		...
		-- Currency default's
		CcurrTypeOne = AJM.currTypes.HonorPoints,
		CcurrTypeOneName = AJM:CurrencyIconAndName(AJM.currTypes.HonorPoints),
		CcurrTypeTwo = AJM.currTypes.WintergraspMarkOfHonor,
		CcurrTypeTwoName = AJM:CurrencyIconAndName(AJM.currTypes.WintergraspMarkOfHonor),
		CcurrTypeThree = 0,
		CcurrTypeThreeName = "",
		CcurrTypeFour = 0,
		CcurrTypeFourName = "",
...
AJM.COMMAND_REQUEST_CURRENCY = "JmbRqCur"
AJM.COMMAND_HERE_IS_CURRENCY = "JmbRcCur"
...
function AJM:CreateJambaCurrencyFrameInfo( characterName, parentFrame )
	...
	-- WHAT THE HELL IS GOING ON HERE! Ebony!
		local height1 = -35 + ( -15 * JambaApi.GetPositionForCharacterNameOnline( characterName) )
